...
function fileToBase64($file){  
    ...
    if(file_exists($file)){  
        ...
        $base64_file = 'data:'.$imageInfo['mime'].';base64,'.$base64_data;  
...
function base64ToFile($base64_data, $file){  
    ...
    return file_put_contents($file, base64_decode($base64_data),false);  
}  

    /**
 	* Description : 发送http的post请求
 	* Author      : jishuai
 	* Created Time: 2015-01-23 21:05
	*/
